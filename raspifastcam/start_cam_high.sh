...
output_file=${1-/home/pi/Desktop/node_programs/tempimages/tmp_%00004d.jpg}


echo "Output will be written to $output_file"

#This will make pictures of 200x200px feel free to change.
/home/pi/Desktop/node_programs/raspifastcam/raspifastcamd -w 200 -h 200 -o $output_file &
pid=$!
